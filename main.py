...
train_images = train_images - int(np.mean(train_images))
train_images = train_images / int(np.std(train_images))
test_images = test_images - int(np.mean(test_images))
...
net.train(training_data, training_labels, 32, 2, 'weights.pkl')
print('Testing Lenet......')
